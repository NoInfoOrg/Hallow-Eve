...
var unpressed_texture = preload("res://assets/ui elements/settings/volume bar/Settings_VolumeArrow_Left.png")
var pressed_texture = preload("res://assets/ui elements/settings/volume bar/Settings_VolumeArrow_Left-Pressed.png")
...
func _on_pressed() -> void:
	...
	if parent_node.name == "Master Volume":
		GlobalInformation.decrease_master_volume()
		...
		GlobalInformation.decrease_music_volume()
		...
		print("volume_left_arrow.gd : unknown parent node. Returning...")
		return
